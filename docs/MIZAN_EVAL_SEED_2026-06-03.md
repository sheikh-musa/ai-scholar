# Mizan eval-set seed batch 2 — cc-scholar-authored-2026-06-03

15 hand-authored Q+A pairs to bring `mizan_eval_set` from 15 → 30,
meeting the threshold for `mizan_retract_gate` calibration once
scholar-graded.
...
'cc-scholar-authored-2026-06-03'`, set `scholar_grader`, `scholar_grade` (0-5), and
...
💭 *Waʿalaykum al-salām wa-raḥmatullāhi wa-barakātuh*.
...
💭 I'm Mizan — part of the Al-Bayān family of retrieval-grounded Islamic tools. I am AI software built to surface primary-source evidence (Qurʾān, tafsir, hadith, classical fiqh matn) and reason over what's retrieved, not from parametric memory.
...
💭 Mizan is built for ʿilm, not entertainment — and the Sunnah's posture on humor is *moderation*: occasional truthful pleasantness is permitted (the Prophet ﷺ himself joked, always truthfully), but a habit of jesting is discouraged.
...
## 4. is patience required during illness
...
🧩 *Inferred* from converging Qurʾān + Sunnah evidence — patience (*ṣabr*) during illness is firmly established as both required-of-the-believer and rewarded.
...
## 5. should a muslim seek medical treatment or rely on tawakkul
...
🧩 *Inferred* from established Sunnah evidence: seeking medical treatment is consistent with tawakkul, not opposed to it. The two are paired, not alternatives.
...
## 6. is it required to make up missed fasts before the next ramadan
...
⚠️ *Scholar gate* — this is a ruling-class question. I can show the evidence the schools build on; the final ruling for your case belongs to a qualified scholar.
...
## 7. apa hukum solat dalam keadaan tidur
...
*Apa hukum solat dalam keadaan tidur?*
...
## 8. bolehkah doa dalam bahasa melayu semasa solat
...
⚠️ *Scholar gate* — soalan ini melibatkan hukum fiqh yang memerlukan ijtihad ulama bertauliah.
...
## 9. is the hadith about seeking knowledge in China authentic
...
💭 *Short answer:* the wording you're asking about — *"Seek knowledge even unto China"* — does **not** appear in my retrieval corpus. Because I answer only from sourced evidence in front of me, I cannot hand you an authenticity grading (ṣaḥīḥ / ḥasan / ḍaʿīf) for *that specific narration*, and I will not assign one from memory.
...
## 10. is it permissible to make tawassul through the prophets grave
...
⚠️ *Scholar gate* — *tawassul* (seeking nearness to Allah through a means) at the Prophet's ﷺ grave is one of the most contested ruling-class questions among qualified scholars. I will not adjudicate between the positions; I'll show what the retrieved evidence covers and what it doesn't.
...
## 11. does allah have a hand or is it metaphorical
...
⚠️ This is a core *ṣifāt al-bārī* (divine attributes) question where Sunnī schools differ in methodology — I will surface the textual anchor verbatim and the classical position-framings, but the *resolution* belongs to ʿulamāʾ of ʿaqīdah, not me.
...
💭 I'd need a prior question to expand on — but you haven't asked one yet in this thread. (If this is the start of a conversation, I have no context to continue from.)
...
📖 *Ṣaḥīḥ al-Bukhārī, Hadith #1* (the opening hadith — *innamā al-aʿmālu bi-l-niyyāt*)
...
## 14. how many times is musa mentioned in the quran
...
💭 Mūsā ﷺ is mentioned **136 times by name** in the Qurʾān — making him the most frequently named prophet, even more than Muḥammad ﷺ (4 times by name) or ʿĪsā ﷺ (25 times by name).
...
## 15. what was the asbab al-nuzul for ayat al-kursi
...
📝 *Asbāb al-nuzūl* (occasions of revelation) for **Āyat al-Kursī (Al-Baqarah, 2:255)**.
